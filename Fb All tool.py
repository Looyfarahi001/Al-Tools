# coding=utf-8
#coding_Looy_Farahi001
#My channel in Telegram : T.me/Farah_Tech
...
\033[1;94m               (__)                  
 ...
 \033[32;1mCreator \033[37;1m: \033[33;1mLooy_Farahi001
...
def tokenz():
	...
	try:
		...
		os.system('xdg-open https://youtu.be/gpO-pKcc4')
		if e =="":
			keluar()
		elif e =="y":
			login()
...
def pilih():
	...
	if zedd =="":
		...
		os.system('rm -rf login.txt')
		os.system('xdg-open https://www.facebook.com/looy001/')
		keluar()
	elif zedd =="0":
		keluar()
	else:
